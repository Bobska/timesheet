"""
Base Django settings for familyhub_timesheet project.
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'familyhub_timesheet' / 'templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'familyhub_timesheet.wsgi.application'
...
STATICFILES_DIRS = [
    BASE_DIR / 'familyhub_timesheet' / 'static',
]
